...
envelopes = [
    esegs [0, 1, 0.8, 0.6, 0.7, 0.6, 0],
    esegs [0, 0.7, 0.8, 1, 0.5, 0.5, 0],
    skipNorm $ segs [0, 1, 0.6, 100, 0.9, 150, 0.7, 100, 0.8, 80, 0.6, 72, 0],
    skipNorm $ segs [0, 1, 0.5, 209, 0.6, 230, 0.5, 72, 0],
    skipNorm $ segs [0, 1, 0.6, 19,  0.9, 300, 0.3, 192, 0],
    skipNorm $ segs [0, 1, 0.5, 39,  0.8, 260, 0.2, 212, 0]]
