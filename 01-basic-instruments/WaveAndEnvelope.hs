...
-- linear waveforms
f41 = lins [0, 1, 1, 2, 1, 2, -1, 2, -1, 1, 0]          -- 50% pulse(square)
f42 = lins [0, 1, 1, 100, 1, 2, -1, 100, -1, 2, 0]      -- steeper square
f43 = lins [0, 6, 1, 200, 1, 12, -1, 800, -1, 6, 0]     -- 20% pulse
f44 = lins [0, 6, 1, 100, 1, 12, -1, 900, -1, 6, 0]     -- 10% pulse
f45 = lins [0, 500, 1, 24, -1, 500, 0]                  -- sawtooth
f46 = elins [0, 1, 0, -1, 0]                            -- triangle

-- linear envelopes
f32 = lins [0, 12, 0.99, 500, 0]
f33 = lins [0, 1, 0, 49, 0.2, 90, 0.6, 40, 0.99, 25, 0.9, 
            45, 0.5, 50, 0.25, 50, 0.12, 50, 0.06, 50, 0.02, 62, 0]
    
f34 = lins [0, 1, 0, 49, 0.2, 100, 0.6, 50, 0.99, 150, 0.2, 162, 0]
f35 = skipNorm $ lins [0, 1, 0, 49, 0.2, 200, 0.5, 100, 0.2, 162, 0]           -- softer 
f36 = lins [0, 1, 0, 79, 0.5, 60, 0.5, 20, 0.99, 120, 0.4, 140, 0.6, 92, 0]
f37 = lins [0, 1, 0, 149, 0.4, 200, 0.99, 50, 0.5, 50, 0.24, 62, 0]
